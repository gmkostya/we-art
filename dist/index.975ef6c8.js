...
/*stylint-disable*/ // let isPlayed=false;
...
// },false);
// 4-variant
let container = document.querySelector(".video-container"), video = container.querySelector("video"), controls = container.querySelector(".video-controls");
video.load();
video.volume = .2;
container.addEventListener("click", function(e) {
    if (video.paused) {
        if (controls.classList.contains("video-controls--play")) controls.classList.remove("video-controls--play");
        controls.classList.add("video-controls--pause");
        video.play();
    } else {
        if (controls.classList.contains("video-controls--pause")) controls.classList.remove("video-controls--pause");
